...
if you are familiar with that, but  implemented as classes:

A service may manage state, and define methods -- it's just a class::
...
Services are started, stopped and restarted; this way they can start other
services, define background tasks, timers, and much more::
